...
if (isset($_POST['verify_btn'])) {
    $AccountNo = $_POST['verify_id'];

    $sql = "update `login` set status = 'Active' where AccountNo=$AccountNo";
                                                ...
                                                <div class="table-responsive">
                                                    ...
                                                    <table id="EditTable" class="table v-middle" style="margin-top: 30px;">
                                                        ...
                                                        <tbody class="dark_bg">
                                                            ...
                                                            $query = "SELECT * FROM login WHERE Status='Inactive' or Status='Deactivated'";
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="light">
                                                                            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                                                                                ...
                                                                                <button name="verify_btn" id="verify_btn" type="submit" data-toggle="modal" data-target="#Verify" class="btn btn-success"><i class='bx bx-power-off bx-flip-horizontal' name="activate"></i>Activate</button>
                                                                            </form>
                                                                        </td>
                                                                    </tr>
