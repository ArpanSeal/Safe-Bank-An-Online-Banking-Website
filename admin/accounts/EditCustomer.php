            ...
            <div id="content">
                ...
                <div class="container-fluid p-0 px-lg-0 px-md-0">
                    ...
                    if (isset($_POST['Update1'])) {
                        ...
                        if ($First_Name_error == null && $Last_Name_error == null && $Father_Name_error == null && $Mother_Name_error == null && $Birth_Date_error == null && $Mobile_Number_error == null && $Email_error == null) {

                            $query3 = "UPDATE customer_detail SET C_First_Name='$EditFname',C_Last_Name='$EditLname',C_Father_Name='$EditFaname',C_Mother_Name='$EditManame',C_Birth_Date='$EditBDate',C_Mobile_No='$EditMobileNo',C_Email='$EditEmail' WHERE Account_No= '$EditAccountNo'";
                                                        ...
                                                        <div class="row g-2 mb-3">
                                                            <div class="col-md">
                                                                <div class="col-md mb-3">
                                                                    ...
                                                                    <input type="date" name="BirthDate" class="form-control dark_bg light m-wrap" id="BirthDate" placeholder="Birth Date" value="<?php echo DATE($EditBDate);
                                                                    ?>">
