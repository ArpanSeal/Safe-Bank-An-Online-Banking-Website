            ...
            <div class="col-md-12 mt-4">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-center">
                                    <img style="height: 150px;" src="../UserData/assets/img/saving.png" alt="">
                                </div>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title mb-4 ">Set Target Amount</h5>
                                <h1 class="display-5 mt-1 mb-3 text-success"></h1>


                                <div class="d-flex justify-content-center">
                                    <img style="height: 100px;" src="../UserData/assets/img/target.png" alt="">
                                </div>
                    ...
                    <div class="col-sm-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-center">
                                    <img style="height: 150px;" src="../UserData/assets/img/transfer_saving.png" alt="">
                                </div>
