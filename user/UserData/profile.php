    ...
    <div class="container-fluid px-lg-4">
        ...
        <div class="row mt-2">
            <div class="col-sm-4">
                <div class="card">
                    <div>
                        <img class="card-img-top profile-banner" src="https://source.unsplash.com/1600x600/?nature" alt="Card image cap">
                    </div>
                ...
                <form action="code.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row mt-4 ml-5 mr-5">
                        ...
                        <div class="col-sm-12">
                            ...
                            <!-- Upload/Delete Image Button -->

                            <div class="d-flex justify-content-center mt-4">

                                <input name="delete" id="delete" hidden>

                                <label id="deleteLabel" for="delete" class="btn btn-danger profileDelete">
