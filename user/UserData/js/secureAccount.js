$(document).ready(function () {
    ...
    $("#NewUsername").blur(function (e) {
        ...
        if (flag == true) {
            ...
            $("#NewUserError").html("Invalid Username Format ! <br> 1) Username can't start with number. <br> 2) Length must be greater than 5. <br> 3) Must be an alphanumeric value.");
            $("#NewUserError").css("color", "red");
            return false
        }
        e.preventDefault();
...
$("#PasswordBtn").click(function (e) {
    ...
    if (OldPass == "") {
        ...
        $("#OldPassError").text("");
        if (NewPass == "") {
            $("#NewPassError").text("New Password is empty");
